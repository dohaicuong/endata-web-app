...
const PortfolioIcon: React.FC<PortfolioIconProps> = ({
  ...
  if (portfolio === 'Building')
    return <HomeIcon style={{ ...style, color: '#0f5b78' }} {...props} />
  if (portfolio === 'Contents')
    return <LiveTvIcon style={{ ...style, color: 'green' }} {...props} />
  if (portfolio === 'Restoration')
    return <HealingIcon style={{ ...style, color: '#d0a11e' }} {...props} />
